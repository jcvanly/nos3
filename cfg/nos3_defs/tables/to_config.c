...
{
   {
       ...
       {CFE_SB_MSGID_WRAP_VALUE(ARCH_HK_TLM_MID),            {0,0},  32,  0xffff,     TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
       {CFE_SB_MSGID_WRAP_VALUE(ARCH_DEVICE_TLM_MID),        {0,0},  32,  0xffff,     TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
